...
import ru.otus.spring.shell.TestCommand;
...
@Component
public class TestCommandImpl extends AbstractShellComponent implements TestCommand {
    ...
    @Override
    @ShellMethod(value = "Get start test", key = {"st", "start-test"}, group = "test")
    public void run() {
